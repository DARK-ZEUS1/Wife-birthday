document.addEventListener('DOMContentLoaded', function() {
    ...
    const targetDate = new Date(2026, 8, 2, 0, 0, 0); // Sep 2, 2026 (month is 0-indexed, so 8 = September)
let timerInterval;
...
// Start the timer (assuming you call updateAge every second elsewhere)
timerInterval = setInterval(updateAge, 1000);
updateAge(); // run once immediately
